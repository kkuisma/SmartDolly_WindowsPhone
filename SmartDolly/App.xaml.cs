...
namespace SmartDolly
{
    ...
    public sealed partial class App : Application
    {
        ...
        static public SpeechSynthesizer speech = new SpeechSynthesizer();
        static public MediaElement mediaElement = new MediaElement();
        ...
        {
            var voiceStr = await speech.SynthesizeTextToStreamAsync(text);
            mediaElement.SetSource(voiceStr, voiceStr.ContentType);
            mediaElement.Play();
        }
    }
}
